...
@section('content')
    <div class="header-div">
        ...
        <h4><span class="badge badge-info" style="width: 350px; float: left; margin-right: 10px">Авария № {{$title->id}}</span></h4>
        <h4><span class="badge badge-dark" style="width: 350px; float: left; margin-right: 10px">{{$title->datetime}}</span></h4>
    </div>
    <hr class="blackline"/>
    ...
    <div class="header-div">
        <h4><span class="badge badge-primary" style="width: 350px; float: left; margin-right: 10px">События за 30 мин до аварии.</span></h4>
    </div>
    <hr class="blackline"/>
    <!-- otreshkovo   -->
                ...
                <div class="card-body">
                    <?
                        if ($getDate > null){
                            ...
                            echo '<h5><span class="badge badge-dark"style="min-width: 350px; float: left; margin-right: 10px">"'.$title->alarmtext.'"</span></h5>';
                            echo '<h5><span class="badge badge-info"style="min-width: 300px; float: left; margin-right: 10px">'.$title->alarmclass.'</span></h5>';
                            echo '</div>';
                        }
                        else {
                            echo '<div class="header-div">';
    ...
    {{$reports->appends(['num' => $title->num])->links()}}

<hr class="blackline"/>
<a href="/otreshkovo_alarms" class="btn btn-primary">Назад</a>
@endsection
