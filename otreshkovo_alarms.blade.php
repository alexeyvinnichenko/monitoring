...
@section('content')
    <div class="header-div">
        ...
        <h4><span class="badge badge-info" style="width: 350px; float: left; margin-right: 10px">Аварии.</span></h4>
                        ...
                        @forelse ($reports as $report)
                            @if($report->state == 'Появление')
                                <tr style="background-color: #F0E68C ">
                                    ...
                                    <td align="left">
                                        <form method="GET" action="{{'/otreshkovo_alarm'}}" style="margin: 0px 15px">
                                            @csrf
